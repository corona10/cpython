...
const uint32_t _PyUop_Flags[MAX_UOP_ID+1] = {
    ...
    [_BUILD_FROZENMAP] = HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG,
...
const uint16_t _PyUop_Uncached[MAX_UOP_REGS_ID+1] = {
    ...
    [_BUILD_FROZENMAP_r01] = _BUILD_FROZENMAP,
...
const char *const _PyOpcode_uop_name[MAX_UOP_REGS_ID+1] = {
    ...
    [_BUILD_FROZENMAP] = "_BUILD_FROZENMAP",
    [_BUILD_FROZENMAP_r01] = "_BUILD_FROZENMAP_r01",
