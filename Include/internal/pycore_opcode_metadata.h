...
int _PyOpcode_num_popped(int opcode, int oparg)  {
    switch(opcode) {
        ...
        case BINARY_OP_SUBSCR_DICT:
            return 2;
        case BINARY_OP_SUBSCR_FROZEN_DICT:
            return 2;
...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [BINARY_OP_SUBSCR_FROZEN_DICT] = { true, INSTR_FMT_IXC0000, HAS_EXIT_FLAG | HAS_ERROR_FLAG | HAS_ERROR_NO_POP_FLAG | HAS_ESCAPES_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [BINARY_OP_SUBSCR_FROZEN_DICT] = { .nuops = 4, .uops = { { _GUARD_NOS_FROZEN_DICT, OPARG_SIMPLE, 0 }, { _BINARY_OP_SUBSCR_FROZEN_DICT, OPARG_SIMPLE, 5 }, { _POP_TOP, OPARG_SIMPLE, 5 }, { _POP_TOP, OPARG_SIMPLE, 5 } } },
...
const char *_PyOpcode_OpName[267] = {
    ...
    [BINARY_OP_SUBSCR_FROZEN_DICT] = "BINARY_OP_SUBSCR_FROZEN_DICT",
...
const uint8_t _PyOpcode_Deopt[256] = {
    ...
    [BINARY_OP_SUBSCR_FROZEN_DICT] = BINARY_OP,
