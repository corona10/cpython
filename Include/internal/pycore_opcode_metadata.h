...
const struct opcode_metadata _PyOpcode_opcode_metadata[267] = {
    ...
    [BUILD_FROZENMAP] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
    [BUILD_FROZENSET] = { true, INSTR_FMT_IB, HAS_ARG_FLAG | HAS_ERROR_FLAG | HAS_ESCAPES_FLAG },
...
_PyOpcode_macro_expansion[256] = {
    ...
    [BUILD_FROZENMAP] = { .nuops = 1, .uops = { { _BUILD_FROZENMAP, OPARG_SIMPLE, 0 } } },
    [BUILD_FROZENSET] = { .nuops = 1, .uops = { { _BUILD_FROZENSET, OPARG_SIMPLE, 0 } } },
...
const char *_PyOpcode_OpName[267] = {
    ...
    [BUILD_FROZENMAP] = "BUILD_FROZENMAP",
    [BUILD_FROZENSET] = "BUILD_FROZENSET",
