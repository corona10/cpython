...
static void *opcode_targets_table[256] = {
    ...
    &&TARGET_BINARY_OP_SUBSCR_FROZENDICT,
...
static PyObject *Py_PRESERVE_NONE_CC _TAIL_CALL_BINARY_OP_SUBSCR_FROZENDICT(TAIL_CALL_PARAMS);
...
static py_tail_call_funcptr instruction_funcptr_handler_table[256] = {
    ...
    [BINARY_OP_SUBSCR_FROZENDICT] = _TAIL_CALL_BINARY_OP_SUBSCR_FROZENDICT,
...
static py_tail_call_funcptr instruction_funcptr_tracing_table[256] = {
    ...
    [BINARY_OP_SUBSCR_FROZENDICT] = _TAIL_CALL_TRACE_RECORD,
