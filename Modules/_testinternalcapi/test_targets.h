...
static void *opcode_targets_table[256] = {
    ...
    &&TARGET_BINARY_OP,
    &&TARGET_BUILD_FROZENMAP,
    &&TARGET_BUILD_FROZENSET,
...
static PyObject *Py_PRESERVE_NONE_CC _TAIL_CALL_BUILD_FROZENMAP(TAIL_CALL_PARAMS);
static PyObject *Py_PRESERVE_NONE_CC _TAIL_CALL_BUILD_FROZENSET(TAIL_CALL_PARAMS);
...
static py_tail_call_funcptr instruction_funcptr_handler_table[256] = {
    ...
    [BUILD_FROZENMAP] = _TAIL_CALL_BUILD_FROZENMAP,
...
static py_tail_call_funcptr instruction_funcptr_tracing_table[256] = {
    ...
    [BUILD_FROZENMAP] = _TAIL_CALL_TRACE_RECORD,
    [BUILD_FROZENSET] = _TAIL_CALL_TRACE_RECORD,
